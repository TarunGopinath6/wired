...
<html lang="en">
  <head>
    ...
    <title>WIRED - Edit profile</title>
    <!-- MDB icon -->
  ...
  <body style="background-image: url('img/homebg.jpg'); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="row align-content-center mt-5">
      ...
      <form
        ...
        action="../wired/includes/customeredit.inc.php"
        method="post"
      ...
      >
        ...
        <div class="">
            ...
            <option value="3"style="color: black;">Phone</option>
            <option value="4"style="color: black;">Address</option>
    </select>               
        </div>
        <!-- Email input -->
        ...
        <!-- Submit button -->
        <button type="submit" name="ceditsubmit" class="btn btn-primary btn-block mb-4">
          UPDATE 
        </button>
