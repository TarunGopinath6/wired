  ...
  <body style="background-image: url('img/homebg.jpg'); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="row align-content-center mt-5">
      ...
      <form
        ...
        action="../wired/includes/partnerlogin.inc.php"
        method="post"
      ...
      >
        ...
        <!-- Submit button -->
        <button type="submit" name="psigninsubmit" class="btn btn-primary btn-block mb-4">
          Sign in 
        </button>
        <div class="text-center">
          <p class="text-white">
            Not a Partner? <a href="partnersignup.php">Register</a>
          </p>
        </div>
        <?php 
      if(isset($_GET["error"])) {
