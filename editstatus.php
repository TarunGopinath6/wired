  ...
  <body style="background-image: url('img/homebg.jpg'); background-repeat: no-repeat; background-size: cover; overflow-x:hidden;">
    ...
    <div class="row align-content-center mt-5">
      ...
      <form
        ...
        <?php $url = '../wired/includes/editstatus.inc.php?oid='.$_GET["oid"]; ?>
        action="<?= $url ?>"
        method="post"
      ...
      >
        ...
        <div class="">
            ...
            <select class="select btn-outline-white btn-md btn-rounded mb-3" name="statuseditpref">
            <option value="50" style="color: black;">Set Status</option> 
            </select>               
        </div>
        <!-- Email input -->
        <div class="">
            <label class="visually-hidden" for="inlineFormSelectPref" >Preference</label>
            <select class="select btn-outline-white btn-md btn-rounded mb-3" name="statuseditoption">
            <option value="1" style="color: black;">Pending</option> 
            <option value="2" style="color: black;">Delivered</option> 
            </select>               
        </div>

        <!-- Submit button -->
        <button type="submit" name="statuseditsubmit" class="btn btn-primary btn-block mb-4">
          UPDATE 
        </button>
